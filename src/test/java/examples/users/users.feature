...
* def user = read('classpath:Resources/user.json')
    * set user.name = 'yek venki'
#"""
#{
#  "name": "Test User",
#  "username": "testuser",
...
When method get
Then status 200
And match response.name contains 'Leanne'


  * def response_payload = read('classpath:Resources/response.json')
  * def res = karate.jsonPath(response_payload, '$.accounts[*].deposits[*].datetime')
  * print res
  * def validation = read ('classpath:Resources/validator.js')
  * def res2 = call validation res
  * print res2